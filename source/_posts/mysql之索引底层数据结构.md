...
上图中，<b><font color='red'>主键索引</font>中，叶子节点存储的是这一行数据</b>

![Innodb非主键索引存储数据](/images/mysql-1-11.png)
上图中，<b><font color='red'>非主键索引</font>中，叶子节点存储的是这一行数据主键值，然后拿到主键值后再到主键索引B+Tree拿到那一行数据</b>

# 索引最左匹配规则
![索引最左匹配规则](/images/mysql-1-12.png)
1. 单个节点内的数据是递增的
2. 节点间从左到右也是递增的
